...
<tr>
  ...
  <td>
    <button class="btn btn-info" data-toggle="modal"  data-mynim="{{$mod->nim}}" data-mynama="{{$mod->nama}}" data-myalamat="{{$mod->alamat}}" data-myjurusan="{{$mod->jurusan}}" data-myjenis_kelamin="{{$mod->jenis_kelamin}}" data-target="#edit"  > Ubah </button>
  

  <button class="btn btn-danger" data-toggle="modal"  data-mynim="{{$mod->nim}}" data-mynama="{{$mod->nama}}" data-myalamat="{{$mod->alamat}}" data-mykelas="{{$mod->jurusan}}" data-myjenis_kelamin="{{$mod->jenis_kelamin}}" data-target="#delete" >Hapus</button></td>
</tr>
@endforeach
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <button type="btn-danger" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="myModalLabel">Hapus</h4>
      </div>
      <form action="{{route('mahasiswa.destroy','test')}}" method="post" > 
  {{method_field('delete')}}
  {{csrf_field()}} 
       <div class="modal-body">
       <p > Apakah anda yakin?</p>
        <div class="form-group">
        <input type="hidden" class="form-control" name="nim" id="nim" value=""> </div>
